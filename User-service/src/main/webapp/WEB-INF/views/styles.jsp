...
.text-success, .horizontal-menu .bottom-navbar .page-navigation > .nav-item.mega-menu .submenu .category-heading {
  /* color: #38ce3c !important; */ color: #f3f3f3 !important; border-bottom: 1px solid #29698c;}
...
.accordion .card {
  ...
  border-radius: .25rem; border: 1px solid #eeeeee;}
  .accordion .card .card-header {
    background-color: transparent;
    border: none;
    padding: 2rem;border-left: 1px solid #0db6c7; }
    .accordion .card .card-header * {
      font-family: "Open Sans", sans-serif;
      font-size: 1rem; }
...
.jsgrid .jsgrid-button {
  background-image: url(../images/sprites/jsgrid-icons.html); }
...
.lock-screen {
  ...
  .lock-screen .backhground-bg {
    ...
    left: -20px;
    bottom: -20px;
    background: url("../images/samples/lockscreen-bg.html") no-repeat center center;
    background-size: cover;
    overflow: hidden;
    min-height: 100%; }
  .lock-screen .card {
...
.container-scroller .content-wrapper {
  ...
  @media (min-width: 1200px) {
	  /* Chary */
    .container-scroller .content-wrapper {
      /* max-width: 1140px; */max-width: 1280px; } }
...
.social-card {
  ...
  .social-card.card-colored {
    ...
    .social-card.card-colored.twitter-card {
      background-image: url(http://www.bootstrapdash.com/demo/stellar-admin/jquery/template/assets/images/social_icons/twitter-bg.svg); }
      .social-card.card-colored.twitter-card .card-body i {
        color: #1da1f1; }
    .social-card.card-colored.facebook-card {
      background-image: url(http://www.bootstrapdash.com/demo/stellar-admin/jquery/template/assets/images/social_icons/facebook-bg.svg); }
      .social-card.card-colored.facebook-card .card-body i {
        color: #105fb8; }
    .social-card.card-colored.instagram-card {
      background-image: url(http://www.bootstrapdash.com/demo/stellar-admin/jquery/template/assets/images/social_icons/instagram-bg.svg); }
...
.top-bg-color{background-color:rgba(38, 92, 121, 1) !important}
.actionBar-bg-color{background-color:#fff !important}
.navbar-brand img{height:auto !important}
/* .horizontal-menu .bottom-navbar .page-navigation > .nav-item:first-child > .nav-link{color:#444 !important;padding: 15px 10px !important;} */
...
.w-100percent{width:100%;}
.mt-0{margin-top:0px !important}
.mb-0{margin-bottom:0px !important}
.mb-15{margin-bottom:15px !important}
.mb-30{margin-bottom:30px !important}
.light-blue-bg{background:#ecf1fb !important}
</style>
</head>
<body>
